package com.dotnicht.kiotatests.servicecompositions;

import com.dotnicht.kiotatests.servicecompositions.model.ModelRequestBuilder;
...
public class ServiceCompositionsClient extends BaseRequestBuilder {
    /**
     * The model property
    ...
    /**
     * Instantiates a new {@link ServiceCompositionsClient} and sets the default values.
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public ServiceCompositionsClient(@jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
