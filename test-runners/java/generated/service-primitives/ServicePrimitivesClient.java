package com.dotnicht.kiotatests.serviceprimitives;

import com.dotnicht.kiotatests.serviceprimitives.model.ModelRequestBuilder;
...
public class ServicePrimitivesClient extends BaseRequestBuilder {
    /**
     * The model property
    ...
    /**
     * Instantiates a new {@link ServicePrimitivesClient} and sets the default values.
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public ServicePrimitivesClient(@jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
