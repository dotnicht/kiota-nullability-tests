...
// returns a *ItemPostsRequestBuilder when successful
func (m *WithUser_ItemRequestBuilder) Posts()(*ItemPostsRequestBuilder) {
    return NewItemPostsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
