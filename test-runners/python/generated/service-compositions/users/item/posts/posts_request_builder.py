...
class PostsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/users/{user_id}/posts", path_parameters)
    
    def by_post_id(self,post_id: int) -> WithPost_ItemRequestBuilder:
        """
        Gets an item from the kiota_tests.service-compositions.users.item.posts.item collection
