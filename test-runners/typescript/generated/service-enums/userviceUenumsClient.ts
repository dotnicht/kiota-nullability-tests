...
/**
 * Instantiates a new {@link UserviceUenumsClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createUserviceUenumsClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<UserviceUenumsClient>(requestAdapter, pathParameters, UserviceUenumsClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface UserviceUenumsClient extends BaseRequestBuilder<UserviceUenumsClient> {
    /**
     * The model property
     */
 ...
 */
export const UserviceUenumsClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const UserviceUenumsClientNavigationMetadata: Record<Exclude<keyof UserviceUenumsClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    model: {
