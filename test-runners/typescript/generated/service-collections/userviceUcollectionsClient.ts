...
/**
 * Instantiates a new {@link UserviceUcollectionsClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createUserviceUcollectionsClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<UserviceUcollectionsClient>(requestAdapter, pathParameters, UserviceUcollectionsClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface UserviceUcollectionsClient extends BaseRequestBuilder<UserviceUcollectionsClient> {
    /**
     * The model property
     */
 ...
 */
export const UserviceUcollectionsClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const UserviceUcollectionsClientNavigationMetadata: Record<Exclude<keyof UserviceUcollectionsClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    model: {
